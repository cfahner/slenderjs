...
(function(c,e){var b=c.jQuery,f=c.document;c.Slender={version:"0.2"};var d=c.Slender;b(function(){b(".sl-nojs").hide();b(f).on("animationstart MSAnimationStart webkitAnimationStart oAnimationStart",".sl-nojs",function(a){"slNodeInserted"===a.originalEvent.animationName&&b(this).hide()});if(c.location.hash.startsWith("#sl-scroll-")){var a=c.location.hash.substr(11),k=c.pageXOffset||c.document.documentElement.scrollLeft;b.isNumeric(a)&&c.scrollTo(k,a)}});var h={};d.subscribe=function(a,b,d){a in h||
(h[a]=[]);h[a].push({subber:b,func:d})};d.unsubscribe=function(a,k){a in h&&h[a].length&&(h[a]=b.map(h[a],function(a){return a.func===k?e:a}))};d.publish=function(a,k,d){var c=[];b.each(h[a]||[],function(e,f){b.isFunction(f.func)&&c.push(f.func.apply(f.subber,[d||{},k,a]))});return c};var g={},p=1,l={};try{Object.defineProperty(d,"viewConstructors",{get:function(){return g}}),Object.defineProperty(d,"viewInstances",{get:function(){return l}})}catch(B){d.viewConstructors=g,d.viewInstances=l}d.View=
function(){};d.View.prototype.enhance=function(a,b){this.viewId=a;this.element=b;this.onEnhance()};d.View.prototype.restore=function(){this.onRestore();delete this.viewId;delete this.element};d.InlineView=function(a){if("object"!==typeof a)throw TypeError("InlineView requires object blueprint");for(var b in a)this[b]=a[b];d.View.call(this)};d.InlineView.prototype=Object.create(d.View.prototype);d.InlineView.prototype.constructor=d.InlineView;d.defineView=function(a,b){if("object"==typeof b){var c=
function(){d.InlineView.call(this,b)};c.prototype=Object.create(d.InlineView.prototype);c.prototype.constructor=c;g[a]=c}else"function"==typeof b&&(g[a]=b)};d.enhanceViews=function(a){b(a).find("[data-view]").each(function(){if(!b(this).data("SlenderViewId")){var a=b(this).attr("data-view");if(g[a]){var c=new g[a];c instanceof d.View?(a=p,p+=1,l[a]=c,b(this).data("SlenderViewId",a),c.enhance(a,b(this))):(console.log("Not a view, ",a,", ",c),console.trace&&console.trace())}else console.log("No constructor for view, ",
a),console.trace&&console.trace()}})};d.restoreViews=function(a){b(a).find("[data-view]").each(function(){var a=b(this).data("SlenderViewId");a&&(l[a].restore(),delete l[a],b(this).removeData("SlenderViewId"))})};d.TestView=function(){};d.TestView.prototype=Object.create(d.View.prototype);d.TestView.prototype.constructor=d.TestView;d.TestView.prototype.onEnhance=function(){this.element.text("Enhanced "+this.viewId)};d.TestView.prototype.onRestore=function(){this.element.text("Restored "+this.viewId)};
d.defineView("Slender.TestView",d.TestView);d.defineView("Slender.TestInlineView",{onEnhance:function(){this.element.text("Enhanced "+this.viewId)},onRestore:function(){this.element.text("Restored "+this.viewId)}});b(function(){d.enhanceViews(b("body"))});b(f).on("keyup focus","textarea.sl-input",function(){clearTimeout(b(this).data("shrinkTimeout"));var a=b(this),k=b(c).scrollTop();a.css({height:0,"min-height":0,"max-height":0});var d=a[0].scrollHeight+parseFloat(a.css("border-top-width"))+parseFloat(a.css("border-bottom-width"));
...
b("<div class=sl-popwrap>").append(b("<div class=sl-popcontain>").append(b("<div class=sl-pop tabindex=0>").html(c)).click(function(a){a.target===this&&m()})));setTimeout(function(){c.parent().focus()},0)},m=function(){location.href.endsWith("#sl-pop")&&(location.hash="");var a=b("body").find(".sl-popwrap, .sl-popbg");d.restoreViews(a);a.remove();n&&n.focus()},t=/^([0-9]*(\.[0-9]+)?){1}(em|px)?$/,u=function(a){var d={};if(a.is("form")){var e=a.serializeArray(),f;for(f in e)d[e[f].name]=d[e[f].value]}e=
